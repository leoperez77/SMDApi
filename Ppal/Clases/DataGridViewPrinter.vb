...
Class DataGridViewPrinter
	...
	Public Sub New(ByVal aDataGridView As DataGridView, ByVal aPrintDocument As PrintDocument, ByVal CenterOnPage As Boolean, ByVal WithTitle As Boolean, ByVal aTitleText As String, ByVal aTitleFont As Font,
	...
	Public Function DrawDataGridView(ByVal g As Graphics) As Boolean
		...
		Catch ex As Exception
			MessageBox.Show("Operation failed: " & ex.Message & EsIngles.ToString(), Application.ProductName & " - Error", MessageBoxButtons.OK, MessageBoxIcon.[Error])
			Return False
		End Try
	End Function
End Class
